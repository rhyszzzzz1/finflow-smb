...
const DEFAULT_ACCOUNT_CODES = {
  ...
  vendorAdvances: "1400-VENDOR-ADV",
  accountsPayable: "2100-AP",
  goodsReceivedNotInvoiced: "2150-GRNI",
  outputVatPayable: "2200-TAX-OUT",
  customerAdvances: "2300-CUST-ADV",
...
const DEFAULT_ACCOUNT_TREE = [
  {
    ...
    children: [
      ...
      {
        code: "1400-VENDOR-ADV",
        name: "Vendor Advances / Supplier Prepayments",
        type: "asset",
        normalBalance: "debit",
        isControlAccount: true,
        configurableKey: "vendorAdvances",
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        normalBalance: "credit",
        isControlAccount: true,
        configurableKey: "goodsReceivedNotInvoiced",
      },
      {
        code: "2200-TAX-OUT",
      ...
      },
      {
        ...
        normalBalance: "credit",
        isControlAccount: true,
        configurableKey: "customerAdvances",
      },
    ],
  },
  {
